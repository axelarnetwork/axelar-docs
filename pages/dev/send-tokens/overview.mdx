...
In `v0.13.01`+ Axelar's JS SDK abstracts the invocations above in a one-line JS code that can be called directly from any frontend dApp. Example implementations below:
