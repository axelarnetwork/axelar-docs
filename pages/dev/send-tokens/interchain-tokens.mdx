...
The first step is to visit the [Interchain Token Portal](https://testnet.interchain.axelar.dev). Connect your wallet, select a source network where you have funds and choose to deploy a new ERC-20 token. Make sure to choose an initial supply, or choose the advanced option to allow later minting. You can then choose any additional chains for your new token. 
