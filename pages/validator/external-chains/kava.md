...
## Testnet - current latest Testnet version is v0.19.5-testnet
git checkout v0.19.5-testnet

## Mainnet - current latest Mainnet version is v0.19.0
...
kava init <moniker_name> --chain-id kava_2221-16000

# Initialize KAVA for Mainnet chain id (kava_2222-10)
kava init <moniker_name> --chain-id kava_2222-10
...
Edit your config.toml file and add the following persistent peers for Testnet:
...
Edit your config.toml file and add the following persistent peers for Mainnet:
...
RPC Testnet: https://kava-testnet.chainode.tech:443
RPC Mainnet: https://kava-mainnet.chainode.tech:443

nano statesync.sh

# add the content below and addapt the RPC for Testnet and Mainnet accordingly
#!/bin/bash
