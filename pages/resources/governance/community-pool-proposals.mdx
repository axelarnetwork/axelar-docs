...
Once the proposal passes or fails (without `NoWithVeto`), the deposit will be refunded. To deposit AXL, follow the [deposit process](https://docs.axelar.dev/cli-docs/v0_31_3/axelard_tx_gov_deposit).
