...
Instructions for `2023-April-11` mainnet upgrade to axelar-core `v0.33.0`, vald `v0.33.0`, and tofnd `v0.10.1`.
...
1. Restart your node with the new `v0.33.0` build.
2. If you're a validator also restart `vald` with `v0.33.0` and `tofnd` with `v0.10.1`.
...
git checkout main
git pull
KEYRING_PASSWORD="pw-1" ./scripts/node.sh -n mainnet -a v0.33.0
# For validators, restart vald/tofnd
KEYRING_PASSWORD="pw-1" TOFND_PASSWORD="pw-2" ./scripts/validator-tools-host.sh -a v0.33.0 -q v0.10.1 -n mainnet
```
