...
Upgrade height `22091922` [countdown](https://www.mintscan.io/axelar-testnet/block/22091922)
...
2. Wait for the proposed upgrade block, `22091922`. Your node will panic at that block height with a log: `{"level":"error","module":"consensus","err":"UPGRADE \"v1.3.1\" NEEDED at height: 22091922",`.
