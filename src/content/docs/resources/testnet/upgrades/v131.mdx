...
2. Wait for the proposed upgrade block, `TODO_UPGRADE_HEIGHT`. Your node will panic at that block height with a log: `{"level":"error","module":"consensus","err":"UPGRADE \"v1.3.1\" NEEDED at height: TODO_UPGRADE_HEIGHT",`.
