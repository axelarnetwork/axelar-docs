...
The `v1.3.1` upgrade is required to support the Axelar Network's upgrade to [Cosmos SDK v0.5.0](https://cosmos-docs.mintlify.app/sdk/v0.50/build). This upgrade will allow for faster block times on Axelar as well as support for the latest security features of the Cosmos SDK.
