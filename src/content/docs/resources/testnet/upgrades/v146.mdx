# Testnet upgrade: v1.4.6

import { Callout } from "/src/components/callout";

Instructions for the testnet upgrade to axelar-core `v1.4.6`.

The release for the upgrade can be found [here](https://github.com/axelarnetwork/axelar-core/releases/tag/v1.4.6).

Upgrade height: **TBD**. Proposal: **TBD**. See [countdown](https://www.mintscan.io/axelar-testnet/block/) once scheduled.
...
```bash
cp -r ~/.axelar_testnet/.core/data ~/.axelar-lisbon-3-upgrade-1.4.6/.core/data
```
...
git checkout main
git pull
KEYRING_PASSWORD="pw-1" ./scripts/node.sh -n testnet -a v1.4.6
# For validators, restart vald/tofnd
KEYRING_PASSWORD="pw-1" TOFND_PASSWORD="pw-2" ./scripts/validator-tools-host.sh -n testnet -a v1.4.6 -q v1.0.1
```
