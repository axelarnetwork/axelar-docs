...
<Callout type="warning" emoji="⚠️">
  ...
  Node operators using binaries need update `wasmvm` to `v1.5.8` [libwasmvm.x86_64.so](https://github.com/CosmWasm/wasmvm/releases/tag/v1.5.8), and add the folder containing the library to `LD_LIBRARY_PATH`.
