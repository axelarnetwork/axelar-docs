...
import { AXELARD } from '/src/config/variables';
...
- `axelard` and `vald` to [{AXELARD}](https://github.com/axelarnetwork/axelar-core/releases/tag/v{AXELARD})
...
5. If you're a validator also restart `vald` with v{AXELARD} and `tofnd` with `v1.0.1`.
