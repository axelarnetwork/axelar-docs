...
Upgrade height `TODO` [countdown](https://www.mintscan.io/axelar/block/TODO)
...
2. Wait for the proposed upgrade block, `TODO`. Your node will panic at that block height with a log: `{"level":"error","module":"consensus","err":"UPGRADE \"v1.2\" NEEDED at height: TODO",`. Stop your node after chain halt.
