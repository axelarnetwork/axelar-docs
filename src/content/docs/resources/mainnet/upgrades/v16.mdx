...
The join scripts should automatically pull the new binary from [Mainnet Resources](/resources/contract-addresses/mainnet/). Or you can add the flag `-a v0.16.1` to force a specific version.
