...
The `v1.1.2` upgrade is a consensus breaking patch release for `v1.0.` `v1.1.` Once live, it will enable the deployment of ITS Hub on mainnet.
...
2. Wait for the proposed upgrade block, `15892300`. Your node will panic at that block height with a log: `{"level":"error","module":"consensus","err":"UPGRADE \"v1.1.2\" NEEDED at height: 15892300",`. Stop your node after chain halt.
