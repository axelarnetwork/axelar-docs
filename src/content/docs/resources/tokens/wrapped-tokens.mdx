...
If you haven't already, import the wrapped ERC-20 token to your MetaMask account in the appropriate network as described in [Set up MetaMask](/resources/metamask/).
