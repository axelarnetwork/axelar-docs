...
Retrieve the ERC-20 info from it's token contract. For `WAVAX`, it can found [here](https://snowtrace.io/address/0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7/contract/43114/readContract/).
...
Submitting this batched data is similar to the description in [Send AXL to an EVM chain](/learn/cli/axl-to-evm).
