...
- [Register Token Metadata with the ITS Contract](#register-token-metadata-with-the-its-contract)
- [Register Custom Token with the Interchain Token Factory](#register-custom-token-with-the-interchain-token-factory)
- [Link Custom Token with the Interchain Token Factory](#link-custom-token-with-the-interchain-token-factory)
- [Assign the `minter` Role to Your Token's Token Manager](#assign-the-minter-role-to-your-tokens-token-manager)
