...
You can see a real example of this function being used in [this transaction on Axelarscan](TODO), which demonstrates registering a token metadata.
...
You can see a real example of this function being used in [this transaction on Axelarscan](TODO), which demonstrates registering a custom coin.
...
You can see a live call to the `link_coin()` call [here](TODO)
