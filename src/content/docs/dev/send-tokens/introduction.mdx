...
## Gateway Tokens
Gateway tokens are a collection of well known ERC20 tokens that have been wrapped by the Common Prefix team to provide easy cross-chain liquidity between blockchains. The full list of available Gateway tokens can be found [here](/resources/contract-addresses/mainnet/#assets).
