...
Instead of deploying a brand-new token, ITS lets you register existing tokens you own on Stellar and seamlessly transfer their value across chains. It achieves this through a canonical token integration, meaning:
