...
With the integration of Stellar to Axelar, Stellar-based contracts can now leverage ITS to interact with tokens from other [blockchain ecosystems](https://axelarscan.io/resources/chains) connected to Axelar.
