...
1. **Confirmed** — The transaction has been confirmed on the source chain and awaits approval in the Axelar network.
...
1. **Failure to execute on destination chain**
...
1. **Insufficient fee or not enough gas**
