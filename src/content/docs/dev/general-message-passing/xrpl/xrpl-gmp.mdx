...
The integration leverages the [XRPL Multisig Signing](https://xrpl.org/docs/concepts/accounts/multi-signing) account type to facilitate message passing. The gateway is controlled by the [Axelar Verifier set](https://axelarscan.io/verifiers).  
