...
From the [Axelar Gateway's](/dev/general-message-passing/sui/gmp-example/#sui-gateway) [channel mod](https://github.com/axelarnetwork/axelar-cgp-sui/blob/main/move/axelar_gateway/sources/channel.move) you will need the `Channel` and `ApprovedMessage` objects. The gateway's [gateway module](https://github.com/axelarnetwork/axelar-cgp-sui/blob/main/move/axelar_gateway/sources/gateway.move) will use the Gateway object.

```rust
use axelar_gateway::channel::{Self, Channel, ApprovedMessage};
use axelar_gateway::gateway::{Self, Gateway};
```
From the [Axelar Gas Service](/dev/general-message-passing/sui/gmp-example/#sui-gas-service) you will use the Gas Service object.
