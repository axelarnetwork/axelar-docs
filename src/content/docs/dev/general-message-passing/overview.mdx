...
- The application must be on one of Axelar's supported EVM chains. See [chain names](https://axelarscan.io/resources/chains) for a list of EVM chains that have an Axelar Gateway deployed. The list is updated as new chains are added.
