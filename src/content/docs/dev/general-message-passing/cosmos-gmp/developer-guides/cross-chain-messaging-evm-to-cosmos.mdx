...
If you encounter the error `"Insufficient aUSDC balance to pay for gas fee,"` please proceed to the [Axelar Discord server](https://discord.gg/aRZ3Ra6f7D). In the faucet channel, kindly paste your axl wallet address in this format: `!faucet axelar16m62wcd7dyednttjgayc08n22z509a70qduwp0`, and then conduct an IBC transfer to your osmo wallet address.
