...
![learn-security-decentralization.png](/images/learn-security-decentralization.svg)
</div>
...
<div class="dark:flex items-center justify-center hidden">
![learn-security-quadratic-voting.png](/images/learn-security-quadratic-voting.svg)
</div>
<div class="dark:hidden items-center justify-center flex">
