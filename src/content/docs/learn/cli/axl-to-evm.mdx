...
- `{AMOUNT}` is the amount of AXL tokens you wish to transfer, denominated in `uaxl`. Recall that `1 AXL = 1000000 uaxl`. See [Testnet Resources](/resources/contract-addresses/testnet/) or [Mainnet Resources](/resources/contract-addresses/mainnet/) for minimum transfer amounts.
