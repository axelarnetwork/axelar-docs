...
- Prerequisites for [Send UST to an EVM chain](/learn/cli/ust-to-evm/)
...
Do not proceed to the next step until you have waited for sufficiently many block confirmations on the EVM chain. Block confirmation minimums can be found at [Testnet Resources](/resources/contract-addresses/testnet/), [Mainnet Resources](/resources/contract-addresses/mainnet/).
