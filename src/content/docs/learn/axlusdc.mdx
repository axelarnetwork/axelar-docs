...
- Acquire axlUSDC in three ways:
  ...
  - Mint via [the Axelar app](https://app.axelar.network/), Axelar's cross-chain bridging interface
...
1. If you're holding USDC and want to take it cross-chain, you can bridge it via [the Axelar app](https://app.axelar.network/).
