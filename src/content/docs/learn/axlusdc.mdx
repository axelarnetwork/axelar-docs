...
- Acquire axlUSDC in three ways:
  ...
  - Swap via liquid pairs on [any of the DEXs listed here](https://www.axelar.network/blog/liquidity-pools-for-bridged-assets-via-axelar).
  - Swap via [Squid](https://www.app.squidrouter.com/), a cross-chain liquidity router built on Axelar.
...
In brief, axlUSDC is generated via [cross-chain bridges](https://www.axelar.network/blog/cross-chain-bridges-benefits-limitations-risks). These dApps accept a deposit of USDC at an Axelar Gateway on Ethereum, and mint an equivalent amount of axlUSDC on the destination chain (minus fees).
...
You can reference [Gateway addresses on various EVM chains and the token addresses of axlUSDC](/resources/contract-addresses/mainnet/).
...
- [Start building with General Message Passing and axlUSDC](/dev/general-message-passing/overview)
