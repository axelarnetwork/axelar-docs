...
<tabs>
    ...
    <tab-item title="Mainnet">
        ...
        Example for mainnet-26,

        ```
        ./boot-tools/transit pull -b ./bootstrap -t mainnet-526-execution -r access --concurrency 10 --timeout 30m
        ```
...
<Callout type="info">
    If you are not joining the network during after a network upgrade, then please reach out to the Flow Foundation on [Discord](www.discord.gg/Flow) for instructions on how to retrieve the bootstrap files.
</Callout>
