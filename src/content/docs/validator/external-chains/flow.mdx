...
> If you are not joining the network during the network upgrade, then please reach out to the Flow Foundation on [Discord](www.discord.gg/Flow) for instructions on how to retrieve the bootstrap files.
