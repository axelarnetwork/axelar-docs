...
Once your node is setup you will need to configure your verifier to run the [ampd daemon](https://github.com/axelarnetwork/axelar-amplifier/tree/main/ampd). This can be done as follows:
