...
Please note, you do not need to add `OPERATOR_ID_MAIN=0.0.12345` or `OPERATOR_KEY_MAIN=302e0201...` to your `.env` file unless you plan to use this node to put transactions on-chain, which is not required for Amplifier message verification.
