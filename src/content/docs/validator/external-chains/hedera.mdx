...
Once your node is up and running, you need to add the Hedera chain to your [ampd's daemon](https://github.com/axelarnetwork/axelar-amplifier/tree/main/ampd) `config.toml`file. This can be done by adding in the following configuration:
