...
**Note:** The network can generate up to 100 GB of logs per day, so it is strongly recommended to archive or delete old files regularly.  
...
You can also configure [`logrotate`](https://manpages.ubuntu.com/manpages/focal/man8/logrotate.8.html) to manage log file rotation automatically.
