...
For faster bootstrapping, use a known reliable peers. Can be found [here](https://github.com/hyperliquid-dex/node?tab=readme-ov-file#mainnet-non-validator-seed-peers).

You can add multiple peers like this:
