...
- Golang 1.17+
- [Official Documentation](https://docs.xrplevm.org/docs/evm-sidechain/join-evm-sidechain-devnet)
...
<Callout emoji="💡">
  This setup has been tested with `exrpd` version `5.0.0`
</Callout>
...
You can download Peersyst's [snapshot](https://evm-sidechain-snapshots-devnet.s3.us-east-1.amazonaws.com/exrpd-pre-v5.tar.lz4). 
