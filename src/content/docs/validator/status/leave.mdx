...
<Callout emoji="💡">
  If you are a Validator that received a delegation from the Axelar Foundation then you may need to reach out to the Foundation to assist with undelegating your staked AXL. You can reach-out at `delegations@axelar.foundation`.
</Callout>