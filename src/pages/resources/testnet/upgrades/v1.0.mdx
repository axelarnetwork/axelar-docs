# Testnet upgrade: v1.0.1

import { Callout } from '/src/components/callout'

## About the v1.0.1 upgrade
...
Upgrade height `14625900` [countdown](https://www.mintscan.io/axelar-testnet/block/14625900)
...
5. If you're a validator also restart `vald` with `v1.0.1` and `tofnd` with `v0.10.1`.

<Callout type="warning" emoji="⚠️">
  [`tofnd` 1.0 has been released](https://github.com/axelarnetwork/tofnd/releases), but we recommend adopting `v1.0.1` of `tofnd` as part of a secondary migration.
</Callout>
