...
Instructions for `2024-February-13` testnet upgrade to axelar-core `v0.35.5`, vald `v0.35.5`, and tofnd `v0.10.1`.
Release can be found [here](https://github.com/axelarnetwork/axelar-core/releases/tag/v0.35.5).
