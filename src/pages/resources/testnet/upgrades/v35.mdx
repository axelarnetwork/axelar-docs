...
<Callout type="warning" emoji="⚠️">
  ...
  Node operators using binaries need to download `wasmvm v1.3.1` [libwasmvm.x86_64.so](https://github.com/CosmWasm/wasmvm/releases/tag/v1.3.1) and add it to `LD_LIBRARY_PATH`.
