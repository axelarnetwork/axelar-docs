...
<Callout type="warning" emoji="⚠️">
  Caution: Satellite is used to transfer real assets across main networks. When using it for the first time, try transferring small amounts initially. If you need assistance, use the `FAQ` and `Support` buttons in Satellite for help.
</Callout>
...
See [Mainnet Resources](/resources/contract-addresses/mainnet/) for a reference list of Axelar's cross chain contract addresses, minimum asset transfer amounts, and cross-chain transaction processing fees.
