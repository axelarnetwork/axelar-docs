...
Upgrade height `TBD` at approximately **At 2:00PM UTC on August 27th, 2024** ([countdown](https://www.mintscan.io/axelar-testnet/block/14625900)) 
...
2. Wait for the proposed upgrade block, `TBD`. Your node will panic at that block height with a log: `{"level":"error","module":"consensus","err":"UPGRADE \"v1.0\" NEEDED at height: 14625900", ...}`. Stop your node after chain halt.
