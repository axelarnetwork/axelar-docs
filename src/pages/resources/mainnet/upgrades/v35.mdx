...
This release enables CosmWasm. Contracts created with CosmWasm will require [governance proposals](/dev/amplifier/chain-integration/governance-proposals/) to be deployed for the indefinite future.
</Callout>
