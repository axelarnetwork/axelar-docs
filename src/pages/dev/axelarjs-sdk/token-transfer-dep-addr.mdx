...
- A table of fees is listed here: [mainnet](/resources/contract-addresses/mainnet#cross-chain-relayer-gas-fee) | [testnet](/resources/contract-addresses/testnet#cross-chain-relayer-gas-fee).
- Alternatively, they can be programmatically queried in the SDK's [AxelarQueryAPI](/dev/axelarjs-sdk/axelar-query-api#gettransferfee).
</Callout>
