...
* [Overview](/dev/general-message-passing/gas-services/pay-gas#overview)
* [Example](/dev/general-message-passing/gas-services/pay-gas#example)
* [Alternative gas payment methods for callContract](/dev/general-message-passing/gas-services/pay-gas#alternative-gas-payment-methods-for-callcontract)
* [Alternative gas payment methods for callContractWithToken](/dev/general-message-passing/gas-services/pay-gas#alternative-gas-payment-methods-for-callcontractwithtoken)
* [Two-way Call](/dev/general-message-passing/gas-services/pay-gas#two-way-call)
...
- For `payNativeGasForContractCall`, the following need to match the arguments of a `contractCall` on the `AxelarGateway`:
  ...
  - `destinationAddress`
  - `payload`
{/* - For `payGasForContractCallWithToken` and `payNativeGasForContractCallWithToken`, the following need to match the arguments of a `contractCallWithToken` on the `AxelarGateway`: */}
