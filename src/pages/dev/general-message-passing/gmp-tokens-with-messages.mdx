...
- The symbol of the token to transfer, which must be a supported asset ([Mainnet](/reference/contract-addresses/mainnet/) | [Testnet](/reference/contract-addresses/testnet/)).
