...
1. Instantiate the gateway:
    ...
    ```bash
    axelard tx wasm instantiate [gateway CODE ID] \
        '{"verifier_address":"axelar1x3960tw9cml6xsqtvzt4gmw3scauaxdd83rhs9dmlpjfjf9z9s7qjx8g0j","router_address":"axelar1fmsa0f5rs5jyauama96k0umzkktemqawrtn28zrjc0rvx47f68fqckxwuj"}' \
        --keyring-backend test \
        --from wallet \
        --gas auto --gas-adjustment 1.5 --gas-prices 0.007uamplifier \
        --chain-id devnet-amplifier \
