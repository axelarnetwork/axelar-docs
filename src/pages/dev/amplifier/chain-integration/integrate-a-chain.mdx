...
Once you are running `ampd` and `tofnd`, you can onboard a chain with the Amplifier by instantiating the `gateway`, `voting verifier`, and `multisig prover` contracts.
...
1. Deploy the gateway:
    ...
    Remember to save your `code_id`s.
