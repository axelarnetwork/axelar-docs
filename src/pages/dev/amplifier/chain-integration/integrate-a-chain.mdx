...
1. Instantiate the voting verifier contract on the command line. See the [testnet](https://github.com/axelarnetwork/axelar-contract-deployments/blob/main/axelar-chains-config/info/testnet.json), [devnet-amplifier](https://github.com/axelarnetwork/axelar-contract-deployments/blob/main/axelar-chains-config/info/devnet-amplifier.json), or [devnet-verifiers](https://github.com/axelarnetwork/axelar-contract-deployments/blob/main/axelar-chains-config/info/devnet-verifiers.json) configurations for the correct `code_id`.
    ...
    [Valid Message IDs](https://github.com/axelarnetwork/axelar-amplifier/blob/main/packages/axelar-wasm-std/src/msg_id/mod.rs#L43) and [Valid Address Formats](https://github.com/axelarnetwork/axelar-amplifier/blob/main/packages/axelar-wasm-std/src/address.rs#L17) can be found in the Amplifier source.
