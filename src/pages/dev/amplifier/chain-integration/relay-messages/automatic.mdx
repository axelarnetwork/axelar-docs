...
For an example of how to have your Relayer and its components to interact with the Amplifier API, please see the following [guide](https://github.com/axelarnetwork/axelar-examples/blob/main/examples/amplifier/README.md).