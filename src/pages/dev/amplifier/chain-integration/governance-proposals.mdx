...
```bash
axelard tx gov submit-proposal store-instantiate [path to contract as wasm binary or gzip] \
'{
    "governance_address": "axelar10d07y265gmmuvt4z0w9aw880jnsr700j7v9daj",
    "service_registry_address": "axelar1c9fkszt5lq34vvvlat3fxj6yv7ejtqapz04e97vtc9m5z9cwnamq8zjlhz",
    "service_name":"validators",
...
--title="Store and instantiate verifier contract for [chain name]" \
--description="Store and instantiate verifier contract for [chain name]" \
--run-as $NETWORK_GOV_ADDRESS \
--label "[chain name]" \
--deposit=2000000000uamplifier \
--keyring-backend test \
...
axelard tx gov submit-proposal store-instantiate [path to contract as wasm binary or gzip] \
    ...
    --title="Store and instantiate gateway contract for [chain name]" \
    --description="Store and instantiate gateway contract for [chain name]" \
    --run-as $NETWORK_GOV_ADDRESS \
    --label "[chain name]" \
    --deposit=2000000000uamplifier \
    --keyring-backend test \
...
export ADMIN_ADDRESS="axelar1zlr7e5qf3sz7yf890rkh9tcnu87234k6k7ytd9"
export NETWORK_GOV_ADDRESS="axelar10d07y265gmmuvt4z0w9aw880jnsr700j7v9daj"
export RPC="http://devnet-amplifier.axelar.dev:26657"
```
...
"gateway_address": "0xFe34259F1EEc1Ea702A175bC5C2a4a29df6cfb43", # Fantom source gateway address
...
"service_registry_address":"axelar1c9fkszt5lq34vvvlat3fxj6yv7ejtqapz04e97vtc9m5z9cwnamq8zjlhz",
"voting_verifier_address": "0xFe34259F1EEc1Ea702A175bC5C2a4a29df6cfb43", # Fantom voting verifier source gateway address
...
"encoder": "abi",
"key_type": "ecdsa",
"domain_separator": "6973c72935604464b28827141b0a463af8e3487616de69c5aa0c785392c9fb9f" # Hash of chain name, admin address, and code ID converted into a String in hex format without `0x`.
    }' \
...
"encoder": "abi",
"key_type": "ecdsa",
"domain_separator": [hash($CHAIN_NAME, $ADMIN_ADDRESS, 505)]
    }' \
    --title="Store and instantiate prover contract for [chain name]" \
    --description="Store and instantiate prover contract for [chain name]" \
    --run-as $NETWORK_GOV_ADDRESS \
    --label "[chain name]" \
    --deposit=2000000000uamplifier \
    --keyring-backend test \
