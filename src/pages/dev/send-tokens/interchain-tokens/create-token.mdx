...
If you want your token to have more features than the standard Interchain Token, you can create a [custom token](../../glossary/#custom-token). With these tokens, you can specify minting policies, ownership structures, rate limits, and other bespoke functionality.
