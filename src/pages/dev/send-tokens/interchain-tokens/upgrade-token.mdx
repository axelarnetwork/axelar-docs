...
If you have an ERC-20 token on a single chain and want a wrapped, bridgeable version on other chains, register and deploy it as a canonical token.

### Option 1: Register your token as a canonical Interchain Token
...
### Option 2: Deploy a new remote canonical Interchain Token for your token
