...
<Callout emoji="🚨">
  **NOTE:** The security of your token is limited to the security of the chains it integrates with. When making a token interchain, make sure that all the chains it will be deployed on are trustworthy.
</Callout>
