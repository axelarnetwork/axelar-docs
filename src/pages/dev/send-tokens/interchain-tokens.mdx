...
1. [Create a new Interchain Token](#create-a-new-interchain-token)
    ...
    A. [Register and create a new Interchain Token using the Interchain Token Portal](#create-a-new-interchain-token) 
...
/**
	...
	* @dev `gasValue` exists because this function can be part of a multi call involving multiple functions that could make remote contract calls.
	*/
