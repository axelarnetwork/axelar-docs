...
```bash
# Set the RPC url for your own L1 (Ethereum) node:
OP_NODE_L1_ETH_RPC=[your ethereum RPC]

# Set the url for your own L1 CL beacon endpoint:
OP_NODE_L1_BEACON=[your beacon node]
```
3. Run:
