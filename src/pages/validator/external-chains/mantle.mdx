# Mantle
Instructions to set up your Mantle node.
## Requirements
...
<tabs>
    <tab-item title="Mainnet">
        ...
        ```bash
        ETH1_HTTP=your_l1_mainnet_node
        ```
    </tab-item>
    <tab-item title="Testnet">
        Set the following config options in `docker-compose.yml`:
        ```bash
        ETH1_HTTP=your_l1_goerli_node
        ```
    </tab-item>
</tabs>
...
```bash
[+] Running 6/6
 ✔ replica 5 layers [⣿⣿⣿⣿⣿]      0B/0B      Pulled                                                                                                     0.8s
   ✔ 0cdfa0c98ed7 Pull complete                                                                                                                        0.2s
   ✔ da01580fbcc6 Pull complete                                                                                                                        0.2s
   ✔ 84538b0ffca1 Pull complete                                                                                                                        0.5s
   ✔ 4f4fb700ef54 Pull complete                                                                                                                        0.5s
   ✔ 235efed51b63 Pull complete                                                                                                                        0.5s
[+] Running 1/1
 ✔ Container mantlenetworks-replica-1  Started                                                                                                         0.3s                                                                                                                                97.4s
```
