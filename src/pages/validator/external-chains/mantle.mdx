...
Download the latest snapshot for a quicker sync: [Mainnet](https://github.com/mantlenetworkio/networks/blob/main/run-node-mainnet.md) | [Testnet](https://github.com/mantlenetworkio/networks/blob/main/run-node.md)
