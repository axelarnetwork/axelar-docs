...
<tabs>
    ...
    <tab-item title="Testnet">
        Set the following config option in [goerli/envs/geth.env](https://github.com/mantlenetworkio/networks/blob/99344b50e3b792d91a83ba89304ef6f479585ae7/goerli/envs/geth.env#L31):
        ```bash
        GCMODE=full
        ```
    </tab-item>
...
<Callout type="warning" emoji="⚠️">
  Make sure to set `ETH1_HTTP` above to your own Ethereum RPC node for security.
</Callout>
