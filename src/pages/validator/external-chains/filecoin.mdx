...
<tabs>
<tab-item title="Mainnet">
 <pre><code>aria2c -x5 https://snapshots.mainnet.filops.net/minimal/latest.zst</code></pre>

</tab-item>
<tab-item title="Testnet">
 <pre><code>aria2c -x5 https://snapshots.hyperspace.yoga/hyperspace-latest-pruned.car</code></pre>
