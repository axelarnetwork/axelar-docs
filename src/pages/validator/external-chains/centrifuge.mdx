...
or be fully trustless either by cloning the [cent-chain repository(https://github.com/centrifuge/centrifuge-chain/)]
...
and look for the listed Docker Image for the latest release or use `main-latest`. 
