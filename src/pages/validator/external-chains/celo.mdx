...
<tab-item title="Mainnet">
 <pre><code>export CELO_IMAGE=us.gcr.io/celo-org/geth:mainnet</code></pre>

</tab-item>
<tab-item title="Alfajores Testnet">
 <pre><code>export CELO_IMAGE=us.gcr.io/celo-org/geth:alfajores</code></pre>
