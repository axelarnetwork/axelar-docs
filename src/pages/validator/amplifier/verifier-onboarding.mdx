...
1. Fund the verifier address.
    ...
    1. Go to the #faucet channel and submit a request with your account to get 100 test tokens.
        ...
        ```bash
        !faucet devnet-verifier axelar1suw3fsckht00c5srgtr8p6lhn58e9lxq9yf5th
        ```
...
1. Bond the verifier:
    ...
    ```bash
    ampd bond-worker validators 100 uamplifier
    ```
...
1. Register support for desired chains, enabling `ampd` to participate in voting and signing for the specified chains:
