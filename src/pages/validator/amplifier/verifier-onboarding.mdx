...
<Callout>
The address for your verifier node will also be the address rewards are sent to (this will change in the future). You should make sure to claim and move any available rewards regularly to mitigate risks associated with this.
</Callout>
