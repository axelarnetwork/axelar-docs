...
1. Download [`ampd`](https://github.com/axelarnetwork/axelar-amplifier/tree/main/ampd), the off-chain daemon responsible for voting and signing with the amplifier protocol. 
