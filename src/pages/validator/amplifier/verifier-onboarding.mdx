...
1. Pull and Run `tofnd`. 

    You should pull and run the latest version of `tofnd` with the following command:
    ...
    You should leave this process running in the background, and perform additional commands in a new terminal window or shell.
