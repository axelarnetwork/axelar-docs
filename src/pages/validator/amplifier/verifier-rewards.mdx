...
You can get chain names and the addresses of the rewards, voting verifier, and multisig contracts through devnet-verifiers.json or devnet-amplifier.json. 
